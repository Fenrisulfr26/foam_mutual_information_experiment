    ...
    function onShowIntensityOverview(~, ~)
        try
            ...
            for pointIdx = 1:9
                ...
                histCubeForDisplay = correctHistForIntensityDisplay(histCube);
...
%% --- Data loading / plotting ---
    ...
    function histCubeForDisplay = correctHistForIntensityDisplay(histCube)
        histCubeForDisplay = correct_hot_dark_pixels(histCube);
        histCubeForDisplay = double(histCubeForDisplay);
    ...
    function openFullPointView(pointIdx, modeName)
        try
            ...
            histCubeForDisplay = correctHistForIntensityDisplay(histCube);
            my_display_hist(histCubeForDisplay);
            fig = gcf;
